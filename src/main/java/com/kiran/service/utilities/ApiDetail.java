...
public enum ApiDetail {
    ...
    ProductAPI("product",
            ...
            "fathom test product_item/product_create_validations.rb -c env:local id:1 brand:BQ types:CHOICE_BUNDLE",
    ...
    FulfillmentAPI("fulfillment",
            ...
            "fathom test fulfillment_item/fulfillment_create_validations.rb -c env:local id:1 brand:BQ types:SINGLE",
            "fathom test fulfillment_item -c env:local id:1 brand:BQ types:SINGLE"),
    PriceListAPI("price",
            "8200",
            "/Users/kgautam/Drive/projects/slate/price-list-api",
            "fathom test price/price_create.rb -c env:local id:1 brand:BQ",
            "fathom test price -c env:local id:1 brand:BQ"),
    ScheduleAPI("schedule",
            "8210",
            "/Users/kgautam/Drive/projects/slate/schedule-api",
            "fathom test schedule/schedule_create_validations.rb -c env:local id:1 brand:BQ",
            "fathom test schedule -c env:local id:1 brand:BQ"),
    ContinuityAPI("continuity",
            "8220",
            "/Users/kgautam/Drive/projects/slate/continuity-api",
            "fathom test continuity/continuity_create_validations.rb -c env:local id:1 brand:BQ",
    ...
    InstallmentAPI("installment",
            ...
            "fathom test installment/installment_create_validations.rb -c env:local id:1 brand:BQ",
            "fathom test installment -c env:local id:1 brand:BQ"),
    MarketingAPI("marketing",
            "8240",
            "/Users/kgautam/Drive/projects/slate/marketing-api",
            "fathom test marketing_program/marketing_program_create_validations.rb -c env:local id:1 brand:BQ",
    ...
    PriceModelAPI("price_model",
            ...
            "fathom test price_model/price_model_create_validations.rb -c env:local id:1 brand:BQ",
    ...
    TieredShippingAPI("tiered_shipping",
            ...
            "fathom test tiered_shipping/tiered_shipping_create_validations.rb -c env:local id:1 brand:BQ",
    ...
    ProductShippingAPI("product_shipping",
            ...
            "fathom test product_shipping/product_shipping_create_validations.rb -c env:local id:1 brand:BQ",
